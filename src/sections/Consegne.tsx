  ...
  const data = [
    {
     ...
     <h1 className="text-neutral-200 text-2xl md:text-4xl font-bold mb-8">
            ...
            <h2 className="text-neutral-200 text-xs md:text-sm font-normal mb-8"><a href="https://nexusknights.github.io/nexusknights-project/FHCI-C1.pdf" target="_blank" className="flex items-center gap-1">
          vai al file canva
    ...
    },
    {
      ...
      content: (
        <div>
         ...
         <h2 className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
